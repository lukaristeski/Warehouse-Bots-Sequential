...
public class GUI extends JPanel {
    ...
    public GUI() {
        int w = MARGIN * 2 + GameState.WIDTH * TILE;
        int h = MARGIN * 2 + GameState.HEIGHT * TILE;
        ...
        timer = new Timer(120, e -> {
            if (GameState.allBotsDone()){
                ...
                repaint();
                System.out.println("All tasks finished at tick " + GameState.tick + " ===");
